...
{this.state.taskMode == 0? (
            ...
            <div class="col-12 TaskRecordEdit">
                <div class="row">
                <div class="col-2 taskMainCell"><div class="row"><div class="col-3 taskCell cellBtn" onClick={(e) => {this.EnterNormalMode(0)}}><i class="fas fa-trash"></i></div><div class="col-3 taskCell cellBtn" onClick={(e) => {this.EnterNormalMode(1)}}><i class="fas fa-save"></i></div><div class="col-6 taskCellDisabled"></div></div></div>
